...
<h3> Semester:</h3><select class="i3" type="text" placeholder="BCA 1st" name="t5"required>
...
$p1=$_POST[t1];
	...
	$q2="insert into bca1 values('$p1','$p2','$p3','$p4','$p5','$p6');";
